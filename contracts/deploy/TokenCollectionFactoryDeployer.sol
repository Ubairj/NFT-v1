...
import "../factories/TokenCollectionFactory.sol";

/// @title TokenCollectionFactoryDeployer
...
contract TokenCollectionFactoryDeployer {
    ...
    function deploy(uint256 amount, uint256 salt) public onlyDeployer {
        ...
        bytes memory craetionCode = type(TokenCollectionFactory).creationCode;
