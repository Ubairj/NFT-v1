...
import "../minting/MintingRegistry.sol";

/// @title MintingManagerDeployer
...
contract MintingRegistryDeployer {
    ...
    function deploy(uint256 amount, uint256 salt) public onlyDeployer {
        bytes memory craetionCode = type(MintingRegistry).creationCode;
