...
import "../factories/GemPoolFactory.sol";

/// @title GemPoolFactoryDeployer
...
contract GemPoolFactoryDeployer {
    ...
    function deploy(uint256 amount, uint256 salt) public onlyDeployer {
        bytes memory craetionCode = type(GemPoolFactory).creationCode;
