...
/// @title ERC1155MultiWrapperDeployer
...
contract ERC1155MultiWrapperDeployer {
    ...
    function deploy(uint256 amount, uint256 salt) public onlyDeployer {
        ...
        IControllable(_deployedToken).addController(msg.sender);
        deployments[salt] != _deployedToken;
        emit Deployed(salt, _deployedToken);
    }
