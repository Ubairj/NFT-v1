...
import "../factories/MutationPoolFactory.sol";

/// @title MutationPoolFactoryDeployer
...
contract MutationPoolFactoryDeployer {
    ...
    function deploy(uint256 amount, uint256 salt) public onlyDeployer {
        bytes memory craetionCode = type(MutationPoolFactory).creationCode;
