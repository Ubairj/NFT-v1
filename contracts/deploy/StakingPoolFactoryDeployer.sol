...
import "../factories/StakingPoolFactory.sol";

/// @title StakingPoolFactoryDeployer
...
contract StakingPoolFactoryDeployer {
    ...
    function deploy(uint256 amount, uint256 salt) public onlyDeployer {
        ...
        bytes memory craetionCode = type(StakingPoolFactory).creationCode;
