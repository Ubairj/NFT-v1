...
/// @notice Interface for an NFT locker - a locker that allows someone to drop off an NFT that another person that owns another NFT can pick up.
interface ILocker {
    /// @notice the contents of the locker
    ...
    /// @notice fired when a gem is dropped off
    ...
    /// @notice fired when a gem is picked up
